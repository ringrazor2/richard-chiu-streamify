        ...
        <div className="navBar__sep">
          ...
          <div>
            <li>
              ...
              >
                <img className="navBar__icons" src={home} alt="home icon"></img>
                Home
              </NavLink>
            </li>
            <li>
            ...
            <li>
              ...
              >
                <img className="navBar__icons" src={chat} alt="chat icon"></img>
                Chat
              </NavLink>
            </li>
            <li>
              ...
              >
                <img className="navBar__icons" src={grid} alt="list icon"></img>
                3 x 3
              </NavLink>
            </li>
          </div>
